...
export default function Signup(props) {
    ...
    const [
        { username, password, "confirm-password": confirmPassword, friendCode },
        setForm,
    ] = useState({
        username: "",
        password: "",
    ...
    async function handleCreateAccount(e) {
        ...
        if (!friendCode.trim()) return setError("Must include friend code");
    ...
    return (
        <>
            <Head>
                ...
                <meta
                    name="description"
                    content="Create an account on Booker"
                />
                <link
                    rel="icon"
